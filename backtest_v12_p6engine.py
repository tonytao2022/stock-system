#!/usr/bin/env python3
"""
V9 全量回测 — 夏季增强+混沌优化版 + P6完整评分引擎
==============================================
V8基础上混沌期修改：持有25天/止损-10%/启用P4延期
...
# ── 季节参数矩阵 ──
SEASON_PARAMS = {
    'summer':          {'buy_min_score':75,'max_hold':60,'stop_loss_t1':12,'stop_loss_t2':9,'p4_enabled':True,'p4_min_score':55,'p4_extension_days':15,'trailing_stop_pct':18,'t2_enabled':True},
    'autumn':          {'buy_min_score':75,'max_hold':25,'stop_loss_t1':8,'stop_loss_t2':6,'p4_enabled':True,'p4_min_score':65,'p4_extension_days':5,'trailing_stop_pct':12,'t2_enabled':True},
    ...
    'spring':          {'buy_min_score':75,'max_hold':20,'stop_loss_t1':8,'stop_loss_t2':6,'p4_enabled':True,'p4_min_score':60,'p4_extension_days':5,'trailing_stop_pct':12,'t2_enabled':True},
...
def gen_report(trades):
    ...
    summary={'strategy':'V10_秋弱秋优化_P6引擎','n_trades':n,'win_rate':round(wr,2),'return_pct':round(tr,4),'profit_factor':round(pf,2),'sharpe':round(sharpe,2)}
