...
# ── 季节参数矩阵 ──
SEASON_PARAMS = {
    'summer':          {'buy_min_score':72,'max_hold':60,'stop_loss_t1':12,'stop_loss_t2':9,'p4_enabled':True,'p4_min_score':55,'p4_extension_days':15,'trailing_stop_pct':18,'t2_enabled':True},
    ...
    'spring':          {'buy_min_score':72,'max_hold':20,'stop_loss_t1':8,'stop_loss_t2':6,'p4_enabled':True,'p4_min_score':60,'p4_extension_days':5,'trailing_stop_pct':12,'t2_enabled':True},
