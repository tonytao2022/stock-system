...
PARAMS = {
    'summer':         {'buy_min':74,'max_hold':30,'sl_t1':12,'sl_t2':9,'trail':18,'sgl':50,'ttl':50},
    'spring':         {'buy_min':74,'max_hold':30,'sl_t1':12,'sl_t2':9,'trail':15,'sgl':35,'ttl':40},
    'weak_spring':    {'buy_min':74,'max_hold':25,'sl_t1':11,'sl_t2':8,'trail':15,'sgl':35,'ttl':40},
    'chaos_spring':   {'buy_min':74,'max_hold':25,'sl_t1':11,'sl_t2':8,'trail':15,'sgl':20,'ttl':35},
    'chaos':          {'buy_min':74,'max_hold':25,'sl_t1':10,'sl_t2':8,'trail':12,'sgl':20,'ttl':30},
    'chaos_autumn':   {'buy_min':74,'max_hold':20,'sl_t1':8,'sl_t2':6,'trail':10,'sgl':15,'ttl':20},
    'weak_autumn':    {'buy_min':74,'max_hold':20,'sl_t1':8,'sl_t2':6,'trail':12,'sgl':20,'ttl':25},
    'autumn':         {'buy_min':74,'max_hold':20,'sl_t1':10,'sl_t2':8,'trail':12,'sgl':30,'ttl':35},
...
def main(start_date, end_date):
    ...
    print(f"\n{'='*65}")
    print(f"  📊 V13.2 回测（买入线74 + 补仓V2:-8%触,补后-15%止）{start_date}~{end_date}")
    print(f"{'='*65}")
